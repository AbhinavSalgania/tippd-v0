        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">Tippd</span>
            </div>
            <p className="text-white/60 text-sm leading-relaxed">
              The payroll intelligence engine for high-volume hospitality groups.
            </p>
            <p className="text-white/40 text-xs mt-4">
              © 2026 Tippd Inc. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="#integrations" className="text-white/60 hover:text-white transition">
                  Integrations
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-white/60 hover:text-white transition">
                  Pricing
                </a>
              </li>
              <li>
